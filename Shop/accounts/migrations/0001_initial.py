    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, max_length=50, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+$', 'فقط حروف، اعداد و . @ + - _')], verbose_name='نام کاربری')),
